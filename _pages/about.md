...
subtitle: >
  ...
  <a href="https://www.gla.ac.uk/schools/socialpolitical/research/urban-studies-social-policy-research/">Division of Urban Studies &amp; Social Policy</a>, School of Social and Political Sciences, University of Glasgow<br>
  Visiting Professor, <a href="https://www.ucd.ie/geography/">School of Geography</a>, University College Dublin, Ireland
...
In the lab, we are particularly interested in how new forms of urban big data — from government agencies (Glasgow City Council/Region, Edinburgh City Council), commercial companies ([Mobility metrics (Huq)](https://data.ubdc.ac.uk/dataset/huq), [Zoopla](https://data.ubdc.ac.uk/dataset/zoopla), [Peel Ports](https://www.peelports.com/)), non-profit sectors (the Salvation Army, the British Red Cross), sensor networks ([SCOOT traffic flow data](https://doi.org/10.1038/s41597-025-04494-y), [EV charging point data](https://doi.org/10.1016/j.jtrangeo.2026.104667)), and citizens (portable sensing via smartphone/watch apps such as ActivityLog — [iOS](https://github.com/qszhao/ActivityLog-IOS), [Android](https://github.com/qszhao/ActivityLog-Android)) — can help us understand, develop, and govern future cities.
