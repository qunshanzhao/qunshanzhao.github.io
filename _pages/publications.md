...
<p style="font-size:0.86em;opacity:0.85;margin:6px 0 0;">
  Author names shown as links are members of the lab — <span style="color:#0ca678;font-weight:600;">green links</span> are PhD students I (co-)supervise(d), <a href="{{ '/people/' | relative_url }}">pink links</a> are other lab members (postdocs, research assistants, and visitors); click a name to jump to their profile.
