...
<div style="display:flex;flex-wrap:wrap;gap:10px 22px;align-items:center;margin:12px 0 4px;">
  ...
  <a href="{{ '/people/#siqi-jia' | relative_url }}" style="display:flex;align-items:center;gap:8px;"><img src="{{ '/assets/img/people/siqi-jia.jpg' | relative_url }}" alt="Siqi Jia" style="width:40px;height:40px;border-radius:50%;object-fit:cover;" loading="lazy"><span>Siqi Jia</span></a>
</div>
