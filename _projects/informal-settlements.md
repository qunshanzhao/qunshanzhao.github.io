...
<div style="display:flex;flex-wrap:wrap;gap:10px 22px;margin:12px 0 20px;">
  ...
  <a href="{{ '/people/' | relative_url }}" style="display:flex;align-items:center;gap:8px;"><img src="{{ '/assets/img/people/manuella-comerio.svg' | relative_url }}" alt="Manuella Comerio de Paulo" style="width:40px;height:40px;border-radius:50%;object-fit:cover;" loading="lazy"><span>Manuella Comerio de Paulo</span></a>
</div>
